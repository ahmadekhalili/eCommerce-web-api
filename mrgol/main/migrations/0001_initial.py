    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt', models.CharField(default='', max_length=55, null=True, unique=True, verbose_name='alt')),
                ('alt_fa', models.CharField(default='', max_length=55, null=True, unique=True, verbose_name='alt')),
                ('alt_en', models.CharField(default='', max_length=55, null=True, unique=True, verbose_name='alt')),
            ],
            options={
                'verbose_name': 'Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(upload_to=main.models.icon_path_selector, verbose_name='image')),
                ('alt', models.CharField(default='', max_length=55, null=True, unique=True, verbose_name='alt')),
                ('alt_fa', models.CharField(default='', max_length=55, null=True, unique=True, verbose_name='alt')),
                ('alt_en', models.CharField(default='', max_length=55, null=True, unique=True, verbose_name='alt')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_fa', models.CharField(max_length=60, null=True, verbose_name='title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_fa', models.CharField(max_length=60, null=True, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_fa', models.CharField(blank=True, default='', max_length=55, null=True, verbose_name='alt')),
                ('alt_en', models.CharField(blank=True, default='', max_length=55, null=True, verbose_name='alt')),

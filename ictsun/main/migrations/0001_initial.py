# Generated by Django 4.0.3 on 2024-02-03 18:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(allow_unicode=True, blank=True, db_index=False, null=True, unique=True, verbose_name='slug')),
                ('slug_fa', models.SlugField(allow_unicode=True, blank=True, db_index=False, null=True, unique=True, verbose_name='slug')),
                ('slug_en', models.SlugField(allow_unicode=True, blank=True, db_index=False, null=True, unique=True, verbose_name='slug')),
            ],
            options={
                'verbose_name': 'brand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug_fa', models.SlugField(allow_unicode=True, db_index=False, null=True, verbose_name='slug')),
                ('slug_en', models.SlugField(allow_unicode=True, db_index=False, null=True, verbose_name='slug')),
                ('symbole_value', models.CharField(blank=True, max_length=255, verbose_name='symbole value')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to=main.models.image_path_selector, verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(allow_unicode=True, db_index=False, max_length=255, verbose_name='slug')),
                ('slug_fa', models.SlugField(allow_unicode=True, db_index=False, max_length=255, null=True, verbose_name='slug')),
                ('slug_en', models.SlugField(allow_unicode=True, db_index=False, max_length=255, null=True, verbose_name='slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_description_fa', models.TextField(blank=True, default='', null=True, validators=[django.core.validators.MaxLengthValidator(160)], verbose_name='meta description')),
                ('meta_description_en', models.TextField(blank=True, default='', null=True, validators=[django.core.validators.MaxLengthValidator(160)], verbose_name='meta description')),
                ('brief_description', models.TextField(blank=True, validators=[django.core.validators.MaxLengthValidator(1000)], verbose_name='brief description')),
                ('brief_description_fa', models.TextField(blank=True, null=True, validators=[django.core.validators.MaxLengthValidator(1000)], verbose_name='brief description')),
                ('brief_description_en', models.TextField(blank=True, null=True, validators=[django.core.validators.MaxLengthValidator(1000)], verbose_name='brief description')),
                ('detailed_description', models.TextField(blank=True, verbose_name='detailed description')),
                ('detailed_description_fa', models.TextField(blank=True, null=True, verbose_name='detailed description')),
                ('detailed_description_en', models.TextField(blank=True, null=True, verbose_name='detailed description')),
